...
# --- Descargar las películas más populares desde TMDB ---
def download_popular_movies():
    api_key = os.getenv('TMDB_API_KEY')
    base_url = "https://api.themoviedb.org/3/movie/popular"
    params = {"api_key": api_key, "language": "es-ES", "page": 1}
    
    movies = []
    rank = 1  # Inicializar el ranking
...
def upload_to_bigquery(df_movies):
    ...
    dataset_id = 'ASP'
    table_id = 'popular_movies'  # Cambié el nombre de la tabla a 'popular_movies'
...
if __name__ == "__main__":
    df_movies = download_popular_movies()  # Llamé a la función para películas populares
